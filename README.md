...
---
 Grafana peut mettre **entre 1 et 5 minutes** avant d'être pleinement opérationnel (migrations de base de données, chargement des plugins, provisioning des datasources et du dashboard).
---
